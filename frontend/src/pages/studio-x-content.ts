/** Hero: ba “chế độ” minh họa — người thuê | chủ xe | bãi nhận xe */
export type SectionId = 'renter' | 'owner' | 'station'

export const HERO_BACKGROUNDS: Record<
  SectionId,
  { image: string; key: SectionId }
> = {
  renter: {
    image:
  ...
  owner: { image: '/hero-retail.png', key: 'owner' },
  station: {
    image:
...
export const HERO_ORDER: SectionId[] = ['renter', 'owner', 'station']
...
export const PROJECTS: ProjectCard[] = [
  {
    id: '1',
    title: 'Đặt xe theo bãi',
    category: 'Booking & Station',
    image:
